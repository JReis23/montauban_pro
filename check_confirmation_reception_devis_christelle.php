...
<div id="e_conteneur_check">
    <div id="e_view_objectifs_cibles">
        <table>
            <tr>
              <td>Confirmation réception devis</td>
            ...
            <tr>
              <td class="montauban">Confirmation réception devis</td>
            ...
            <tr>
              <td class="facade">Confirmation réception devis</td>
            ...
            <tr>
                <td class="gauthier">Confirmation réception devis</td>
            ...
            <td class="montauban">Confirmation réception devis</td>
              ...
              <tr>
                <td class="funeraire">Confirmation réception devis</td>
