    ...
    <div id="e_view_objectifs_cibles">
        <table>
            ...
            <tr>
              ...
              <td class="check_globaux"><a href="./templates/checkpoint_final.html#ancre2">Vision global</td>
              <td class="archive">Archiver</td>
              

            </tr>
            <tr>
              <td class="facade">RDV</td>
              <td class="facade">Façade</td>
              <td class="facade">Nardou Etienne</td>
              <td class="facade">10/02/2021</td>
              <td class="facade">0545758415</td>
              <td class="check_globaux"><a href="./templates/checkpoint_final.html">Vision global</td>
              <td class="archive">Archiver</td>
            </tr>
            <tr>
                <td class="montauban">RDV</td>
